    ...
    return (
        <React.Fragment>
            <section className="quotes-section">
                <div className="row m-0 fix-element">
                ...
                <div className="row m-0 dynamic-element">
                    ...
                    <div className="changeable-wrapper">
                        <div className="avatar col-lg-12 col-md-12 col-sm-12 col-xs-12 p-3">
                            {/* <AiOutlineLeft size="1.5rem" className="mr-4"/> */}
                            ...
                            {/* <AiOutlineRight size="1.5rem" className="ml-4"/> */}
                        </div>
                        ...
                        <div className="name col-lg-12 col-md-12 col-sm-12 col-xs-12 px-5">Philip Jason</div>
